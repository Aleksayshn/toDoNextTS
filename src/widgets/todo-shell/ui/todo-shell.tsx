...
export function TodoShell() {
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top_left,rgba(255,255,255,0.14),transparent_30%),linear-gradient(135deg,#102542_0%,#182c61_42%,#f87060_100%)] px-5 py-10 text-slate-50 sm:px-8 lg:px-12">
      <div className="mx-auto grid max-w-7xl gap-6 lg:grid-cols-[1.65fr_0.95fr]">
        <section className="rounded-4xl border border-white/15 bg-white/10 p-6 shadow-[0_24px_80px_rgba(5,10,23,0.24)] backdrop-blur md:p-8">
          <div className="mb-8 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            <div className="max-w-2xl">
              ...
              <p className="mt-4 max-w-xl text-base leading-7 text-slate-100/80">
                A small app structured like a larger product: pages compose
                widgets, widgets compose features, and entities keep business
                data stable.
              </p>
            </div>
